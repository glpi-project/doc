-   [Préface](preface.md)
-   [Premiers pas avec GLPI](01-premiers-pas/01_Premiers_pas_avec_GLPI.md)
    -   [Déployer GLPI](01-premiers-pas/02_Déployer_GLPI/02_Déployer_GLPI.md)
        -   [Prérequis](01-premiers-pas/02_Déployer_GLPI/02_Prérequis/01_Prérequis_nécessaires.md)
            -   [Prérequis du serveur web](01-premiers-pas/02_Déployer_GLPI/02_Prérequis/02_Prérequis_serveur.md)
            -   [Prérequis serveur de base de données](01-premiers-pas/02_Déployer_GLPI/02_Prérequis/03_Prérequis_base_de_données.md)

        -   [Installer les pages de l'application GLPI](01-premiers-pas/02_Déployer_GLPI/03_Installer_l'application.md)
        -    [Utiliser l'assistant d'installation](01-premiers-pas/02_Déployer_GLPI/04_Assistant_d'installation.md)

    -   [Utiliser GLPI](01-premiers-pas/03_Utiliser_GLPI/01_Utiliser_GLPI.md)
        ...
        -   [Gérer ses préférences](01-premiers-pas/03_Utiliser_GLPI/04_Gérer_ses_preferences.md)
        ...
        -   [Visualiser les enregistrements](01-premiers-pas/03_Utiliser_GLPI/07_Visualiser_les_enregistrements.md)
        -   [Rechercher](01-premiers-pas/03_Utiliser_GLPI/08_Rechercher.md)

-   [Module Parc](03_Module_Parc/01_Module_Parc.md)
    ...
    -   [Gérer les logiciels](03_Module_Parc/04_Logiciels/01_Logiciels.md)
        - [Gérer les licences](03_Module_Parc/04_Logiciels/02_Onglet_Licences.md)
...
-   Le service d'assistance aux utilisateurs
    -   [Mise en route du service d'assistance](04_Module_Assistance/01_Module_Assistance.md)
    -   [Définir les acteurs et leurs rôles](04_Module_Assistance/02_Définir_les_acteurs.md)
    -   [Définir la matrice de calcul de la priorité](04_Module_Assistance/03_Définir_la_matrice_de_calcul_de_la_priorité.md)
    -   [Configuration_avancée](04_Module_Assistance/04_Configuration_avancée.md)
    -   [Les matrices de cycle de vie](04_Module_Assistance/05_Les_matrices_de_cycle_de_vie.md)
    -   Gérer les tickets
        -   [Règles de gestion](04_Module_Assistance/06_Tickets/01_Règles_de_gestion.md)
        -   [Gérer les tickets](04_Module_Assistance/06_Tickets/03_Gérer_les_tickets.md)
        -   [Ouvrir un tickets](04_Module_Assistance/06_Tickets/04_Ouvrir_un_ticket.md)
        -   [Pour aller plus loin](04_Module_Assistance/06_Tickets/05_Pour_aller_plus_loin.md)
    -   [Créer un ticket](04_Module_Assistance/07_Créer_un_ticket.md)
    -   [Gérer les problèmes](04_Module_Assistance/08_Problèmes.md)
    -   [Gérer les changements](04_Module_Assistance/09_Changements.md)
    -   [Les plannings](04_Module_Assistance/10_Planning.md)
    -   [Les statistiques](04_Module_Assistance/11_Statistiques.md)
    -   [Les tickets récurrents](04_Module_Assistance/12_Tickets_récurrents.md)

-   [Module Gestion](05_Module_Gestion/01_Module_Gestion.md)
    ...
    -   [Gérer les documents](05_Module_Gestion/06_Documents.md)
 
-   [Module Outils](06_Module_Outils/01_Module_Outils.md)
    -   [Gérer les projets](06_Module_Outils/02_Projets/01_Projets.md)
        - [les tâches d'un projet](06_Module_Outils/02_Projets/02_Onglet_Tâches.md)
    ...
    -   [Gérer les rapports](06_Module_Outils/07_Rapports.md)

-   [Module Administration](07_Module_Administration/01_Module_Administration.md)
    -   [Administrer les utilisateurs](07_Module_Administration/02_Utilisateurs/01_Utilisateurs.md)
        -   [Importer des utilisateurs](07_Module_Administration/02_Utilisateurs/02_Importer_des_utilisateurs.md)
    -   [Administrer les groupes](07_Module_Administration/03_Groupes.md)
    -   [Administrer les entités](07_Module_Administration/04_Entités.md)
    -   [Gérer les règles](07_Module_Administration/05_Règles/01_Gérer_les_règles.md)
        -   [Collecteur de courriels](07_Module_Administration/05_Règles/02_Collecteur_de_courriels.md)
        -   [Habilitations utilisateur](07_Module_Administration/05_Règles/03_Habilitations_utilisateur.md)
        -   [Catégorie de logiciels](07_Module_Administration/05_Règles/01_Gérer_les_règles.md)
        -   [Règles métier pour les tickets](07_Module_Administration/05_Règles/04_Règles_métier_pour_les_tickets.md)
        -   [Importer ou lier une machine provenant d'un outil d'inventaire](07_Module_Administration/05_Règles/05_Règles_outil_d'inventaire.md)
            Uniquement si vous utiliser un agent d'inventaire (OCSinventoryNG ou Fusioninventory)
        -   [Transférer](07_Module_Administration/05_Règles/01_Gérer_les_règles.md)
        -   [Listes noires](07_Module_Administration/05_Règles/01_Gérer_les_règles.md)
    -   [Configurer les dictionnaires de données](07_Module_Administration/06_Dictionnaires.md)
 
    -   [Administrer les profils utilisateurs](07_Module_Administration/07_Profils/01_Profils.md)

    -   [Gérer la file d'attente d'envoi des courriels](07_Module_Administration/08_File_d'attente_des_courriels.md)
    -   [Maintenance de GLPI](07_Module_Administration/09_Maintenance.md)
...
-   [Module Configuration](08_Module_Configuration/01_Module_Configuration.md)
    -   [Configurer les intitulés](08_Module_Configuration/02_Intitulés/01_Intitulés.md)
    -   [Configurer les composants](08_Module_Configuration/03_Composantss.md)
    -   [Configurer les notifications](08_Module_Configuration/04_Notifications/01_Configurer_les_notifications.md)
        -   [Configurer les suivis par courriels](08_Module_Configuration/04_Notifications/02_Configuration_des_suivis_par_courriels.md)
        -   [Configuration des modèles de notifications](08_Module_Configuration/04_Notifications/03_Modèles_de_notifications.md)
         -   [Gérer les notifications](08_Module_Configuration/04_Notifications/04_Notifications.md)

    -   [Configurer les SLAs](08_Module_Configuration/05_Sla/01_Sla.md)
        -   [Gérer les nniveaux d'escalade](08_Module_Configuration/05_Sla/02_Niveauxd'escalade.md)

    -   [Configurer les paramètres centraux](08_Module_Configuration/06_Générale/01_Configurer_les_paramètres_centraux.md)
        -   [Configuration générale](08_Module_Configuration/06_Générale/02_Configuration_Générale.md)
