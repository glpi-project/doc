...
.. glossary::
   ...
   Label FQDN
      Un :term:`FQDN` est composé de label séparé par des point ('`.`').
   ...
   VLAN Taggé
      Un :abbr:`VLAN (Virtual Local Area Network)` taggé est un :term:`VLAN` dont le tag est transmis dans la trame réseau (cf. `802.1Q <http://fr.wikipedia.org/wiki/IEEE_802.1Q>`_).
