...
-   [Premiers pas avec GLPI](index.php?fr/01_premiers_pas_avec_GLPI.md)
    -   [Déployer GLPI](index.php?fr/install/installing.md)
        ...
        -   [Installer l'application GLPI](index.php?fr/install/install.md)
            -   [Télécharger l'archive](index.php?fr/install/install_download.html)
            -   [Installer les fichiers de l'application sur le serveur](index.php?fr/install/install_copyfiles.html)
            -   [Utiliser l'assistant d'installation](index.php?fr/install/install_wizard.html)
...
-   [Module Inventaire](inventory.html)
    ...
    -   [Gérer les périphériques](inventory_peripheral.html)
        ...
        -   [Afficher toutes les informations sur une seule
            page](inventory_all.html)
        -   [Ajouter un
            périphérique](inventory_peripheral_t_create.html)
        -   [Voir un
            périphérique](inventory_peripheral_t_read.html)
        -   [Modifier un
            périphérique](inventory_peripheral_t_update.html)
        -   [Supprimer un
            périphérique](inventory_peripheral_t_delete.html)
        -   [Associer un périphérique à un
            document](inventory_peripheral_t_linktodocument.html)
        -   [Associer un périphérique à un
            contrat](inventory_peripheral_t_linktocontract.html)
...
-   [Le service d'assistance aux utilisateurs](helpdesk.html)
...
-   [Module Gestion](management.html)
    ...
    -   [Gérer les contrats](management_contract.html)
        -   [Lier contrats et
            fournisseurs](management_supplier_contract.html)
        -   [Les matériels
